...
export const ANOMALIES: AnomalieMeta[] = [
  ...
  },
  {
    ...
    layer: "Allocataire",
    symptom:
      "Couche Allocataire en perte d'intégrité. Primitives kernel (fork, exec, wait, signaux) émettent des artefacts. Trois actes de réinstanciation à exécuter avant échéance.",
    window: "Rendu Moodle imminent. Trois TPs en retard.",
    urgency: "élevée",
